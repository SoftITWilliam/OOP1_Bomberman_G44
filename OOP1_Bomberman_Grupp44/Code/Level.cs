...
class Level
{
    ...
    public static Level KingOfTheHillLevel()
    {
        Level lvl = new Level(15, 11, (lvl) =>
        {
            ...
            lvl.AddBlock(new DestructibleBlock(7, 3));
            lvl.AddBlock(new DestructibleBlock(7, 7));
            lvl.AddPowerup(new BombRainPowerup(6, 4));
            lvl.AddPowerup(new BombCountPowerup(8, 4));
            lvl.AddPowerup(new RangePowerup(6, 6));
            lvl.AddPowerup(new HealthPowerup(8, 6));
        });
        lvl.Reset();
        return lvl;
    }
    ...
    public static Level CrossHairLevel()
    {
        Level lvl = new Level(15, 11, (lvl) =>
        {
            var SolidBlockPositions = new (int x, int y)[]
            {
                (0,5), (1,1), (1,2), (1,3), (1,5), (1,7), (1,8), (1,9),
                (2,1), (2,5), (2,9), (3,1), (3,3), (3,5), (3,7), (3,9),
                (5,1), (5,3), (5,5), (5,7), (5,9), (6,5), (7,0), (7,1),
                (7,3), (7,4), (7,5), (7,6), (7,7), (7,9), (7,10), (8,5),
                (9,1), (9,3), (9,5), (9,7), (9,9), (11,1), (11,3), (11,5),
                (11,7), (11,9), (12,1), (12,5), (12,9), (13,1), (13,2),
                (13,3), (13,5), (13,7), (13,8), (13,9), (14,5)
            };
            var DestrucBlockPositions = new (int x, int y)[]
            {
                (0,2), (0,8), (1,4), (1,6), (2,0), (2,3), (2,7), (2,10),
                (3,2), (3,4), (3,6), (3,8), (4,0), (4,1), (4,3), (4,5),
                (4,7), (4,9), (4,10), (5,2), (5,4), (5,6), (5,8), (6,1),
                (6,3), (6,4), (6,6), (6,7), (6,9), (7,1), (7,2), (7,8),
                (7,8), (7,9), (8,1), (8,3), (8,4), (8,6), (8,7), (8,9),
                (9,2), (9,4), (9,6), (9,8), (10,0), (10,1), (10,3), (10,5),
                (10,7), (10,9), (10,10), (11,2), (11,4), (11,6), (11,8),
