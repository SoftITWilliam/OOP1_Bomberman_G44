...
/*
    ...
    När en bomb sprängs så behandlas alla påverkade block som IBlock då TryDestroy() anropas. 
    Dynamic Dispatch avgör hur blocket hanterar explosionen; DestructibleBlocks förstörs, och SolidBlocks är opåverkade.
    3. Genom att använda subtypspolymorfism på det här sättet undviker vi conditionals i resten av spelets kod. 
    På det här sättet blir koden tydligare och lättare att läsa. 
    Koden blir också mer flexibel då vi enkelt kan lägga till nya blocktyper utan att ändra i övrig kod.
*/
